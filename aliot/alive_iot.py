...
class ObjConnecteAlive:
    ...
    def send(self, projectId: str, id: str,  value):
       self.sendEvent('send_update', { 'projectId': projectId, 'id': id, 'value': value})
    ...
    def on_open(self, ws):
        ...
        """
        # Register as object
        self.ws.send(json.dumps({'event': 'connect_object', 'data': { 'id': self.__key }}))
